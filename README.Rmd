...
This repository contains all the code and text to generate [this blog post](https://www.datascienceworkshops.com/blog/plotnine-grammar-of-graphics-for-python). The blog post is also available as a Jupyter notebook and an R notebook; these are located in the *output* directory. 
...
This blog post and the accompanying code has been written and tested on macOS. I suspect that it also works on other Unix and Linux distributions. I doubt that it works out of the box on Windows. The *Makefile* and *requirements.txt* files may provide useful hints on how to install the dependencies.
