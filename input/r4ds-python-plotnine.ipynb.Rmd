...
All I had to do was translate[^](If you ever need to translate ggplot2 to plotnine yourself, check out my [follow-up post containing heuristics](/blog/heuristics-for-translating-ggplot2-to-plotnine) for doing so.) the visualization chapters (chapter 3 and 28) from R and ggplot2 to Python and plotnine.
